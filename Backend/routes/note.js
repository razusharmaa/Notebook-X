...
router.post('/addnote', fetchuser, [
  ...
  try {
    ...
    res.status(503).send("Some error occurred while saving")
  }
})
...
router.put('/updatenote/:id', fetchuser, async (req, res) => {
  ...
  res.status(503).send("Some error occurred while upating")
}
})
...
router.delete('/deletenote/:id', fetchuser, async (req, res) => {
  ...
  res.status(503).send("Some error occurred while deleting")
}
})
